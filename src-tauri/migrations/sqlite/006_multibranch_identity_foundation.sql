...
ALTER TABLE sync_outbox ADD COLUMN company_id TEXT NOT NULL DEFAULT '1';
...
ALTER TABLE sync_state ADD COLUMN company_id TEXT NOT NULL DEFAULT '1';
...
ALTER TABLE sync_conflicts ADD COLUMN company_id TEXT NOT NULL DEFAULT '1';
...
ALTER TABLE local_device_identity ADD COLUMN company_id TEXT NOT NULL DEFAULT '1';
...
ALTER TABLE local_pos_invoices ADD COLUMN company_id TEXT NOT NULL DEFAULT '1';
...
ALTER TABLE local_stock_movements ADD COLUMN company_id TEXT NOT NULL DEFAULT '1';
