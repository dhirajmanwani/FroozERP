...
ALTER TABLE branches ADD COLUMN IF NOT EXISTS company_id INTEGER NOT NULL DEFAULT 1;
...
ALTER TABLE authorized_devices ADD COLUMN IF NOT EXISTS company_id INTEGER NOT NULL DEFAULT 1;
...
ALTER TABLE sync_processed_operations ADD COLUMN IF NOT EXISTS company_id INTEGER NOT NULL DEFAULT 1;
...
ALTER TABLE sync_change_log ADD COLUMN IF NOT EXISTS company_id INTEGER NOT NULL DEFAULT 1;
...
ALTER TABLE sync_conflict_log ADD COLUMN IF NOT EXISTS company_id INTEGER NOT NULL DEFAULT 1;
...
ALTER TABLE sync_pos_sale_staging ADD COLUMN IF NOT EXISTS company_id INTEGER NOT NULL DEFAULT 1;
